...
""",
    ...
    "BRIGHT_aops": """Find different but similar math problems to FILL_QUERY_HERE\n\nA document is relevant if it uses the same class of functions and shares **any** overlapping techniques.""",

    "BRIGHT_theoremqa-questions": """Find a passage which uses the same mathematical process as this one: FILL_QUERY_HERE""",

    "BRIGHT_leetcode": """I am looking to find different problems that share similar data structures (of any kind) or algorithms (e.g. DFS, DP, sorting, traversals, etc.). I am looking for problems that share one or both of these similarities to this:
...
""",
    ...
    "BRIGHT_pony": """I will use the programming language pony. Problem: FILL_QUERY_HERE
...
But to solve the problem above, I need to know things about pony. A passage is relevant if it contains docs that match **any** part (even basic parts) of the code I will have to write for the above program.""",
    ...
    "BRIGHT": """Can you find background information about the concepts used to answer the question:
...
PROMPT_DICT["BRIGHT_theoremqa-theorems"] = PROMPT_DICT["BRIGHT_theoremqa-questions"]
